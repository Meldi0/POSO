...
-- Matikan foreign key check saat inisialisasi tabel
...
-- 1. Insert Data Akun Default (Admin, Operator, UPT, Pelapor)
...
-- 2. Insert Data Pengaturan Sistem (SLA Target dalam Jam)
...
-- 3. Insert Contoh Tiket Pengaduan (Sample Active Tickets)
INSERT INTO `tickets` (
...
-- 4. Insert Contoh Thread Pesan Diskusi & Catatan Internal
