...
export const TeamSection: React.FC = () => {
  ...
  const teamMembers = [
    {
      ...
      role: 'CEO',
      alias: 'Capt Hodl',
      bio: 'Former DoD protocol analyst and blockchain strategist driving decentralized finance innovation.',
      avatar: (
    ...
    },
    {
      id: 'maya',
      name: 'Maya Chen',
      altName: 'Theresa Smith',
      role: 'COO',
      alias: 'Peps',
      bio: 'Smart contract security architect and operations strategist with 8+ years building automated liquidity protocols.',
      avatar: (
        <svg viewBox="0 0 160 160" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Avatar Background Circle */}
          <circle cx="80" cy="80" r="70" fill="#311059" />
    ...
    },
    {
      ...
      role: 'Lead Architect',
      alias: 'Vortex',
      bio: 'Core author of the Strato Automated Liquidity protocol and zero-knowledge rollup infrastructure.',
      avatar: (
        <svg viewBox="0 0 160 160" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="80" cy="80" r="70" fill="#311059" />
  ...
  // Determine the 2 members currently in view
  ...
  return (
    <section id="team" className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 py-20">
      ...
      <div className="mb-14">
        ...
        >
          MEET OUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-200 to-pink-300">TEAM</span>
        </motion.h2>
        <p className="text-xs sm:text-sm font-bold text-purple-300/70 uppercase tracking-widest mt-2">
          Strato Protocol Developers & Innovators
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
        <AnimatePresence mode="wait">
          {visibleMembers.map((member, idx) => (
            ...
            >
              {/* Top Avatar Box with Vibrant Gradient Lighting */}
              ...
              <div>
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  <span className="text-[11px] text-purple-300/60 font-mono">Verified Lead</span>
                </div>
              ...
              <div className="mt-6 pt-4 border-t border-purple-500/20 flex items-center gap-3">
                <a href="#twitter" className="w-8 h-8 rounded-full bg-purple-900/50 hover:bg-pink-600/80 border border-purple-400/30 flex items-center justify-center text-purple-200 hover:text-white transition-all">
                  <Twitter className="w-3.5 h-3.5" />
                </a>
                <a href="#linkedin" className="w-8 h-8 rounded-full bg-purple-900/50 hover:bg-pink-600/80 border border-purple-400/30 flex items-center justify-center text-purple-200 hover:text-white transition-all">
                  <Linkedin className="w-3.5 h-3.5" />
                </a>
                <a href="#github" className="w-8 h-8 rounded-full bg-purple-900/50 hover:bg-pink-600/80 border border-purple-400/30 flex items-center justify-center text-purple-200 hover:text-white transition-all">
