    ...
    <div className="relative min-h-screen bg-[#F4F7FB] text-[#0F172A] font-sans selection:bg-[#002B49] selection:text-white flex flex-col justify-between overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute top-[5%] -right-24 w-[850px] h-[850px] rounded-full bg-gradient-to-bl from-[#F58A61]/15 via-[#FB923C]/12 to-[#FEF08A]/15 blur-[95px]"
        />
        ...
        <div className="w-full max-w-[1720px] mx-auto px-4 sm:px-8 lg:px-12 h-20 flex items-center justify-between gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-6 xl:gap-8 text-sm xl:text-base font-bold text-slate-700 whitespace-nowrap">
            ...
            <button 
              ...
              className="hover:text-[#002B49] transition-colors font-bold cursor-pointer flex items-center gap-1.5"
            >
              <Shield className="w-4 h-4 text-[#0D5C75]" />
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div 
              ...
              className="lg:hidden bg-white border-b border-slate-200 px-6 py-5 space-y-4 shadow-lg overflow-hidden"
            >
